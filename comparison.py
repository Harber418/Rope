...
def position(sets):
    ...
    plt.plot(x, y, label='Implicit - GL2 ',alpha = 0.8, c = "r")
...
def plot_force_comparison(sets):
    ...
    plt.plot(x, plotting[0], label='Implicit - GL2', alpha = 0.8, c = "r")
...
def plot_kinetic_energy_comparison(sets):
    """
    ...
    data_r4 = np.load(r4)
    data_r5 = np.load(r5)
    v_hist_rk1 = data_r1['v_hist']
    v_hist_rk2 = data_r2['v_hist']
    v_hist_rk3 = data_r3['v_hist']
    v_hist_rk4 = data_r4['v_hist']
    v_hist_rk5 = data_r5['v_hist']
    ...
    fall_factor_rk4 = data_r1['fall_factor']
    masses_rk4 = data_r1['masses']
    masses_impl = data_r2['masses']
    masses_3 = data_r3['masses']
    masses_4 = data_r4['masses']
    masses_5 = data_r5['masses']
    ...
    ke_rk4 = total_ke(v_hist_rk1, masses_rk4)
    ke_impl = total_ke(v_hist_rk2, masses_impl)
    ke3 = total_ke(v_hist_rk3, masses_3)
    ke4 =total_ke(v_hist_rk4, masses_4)
    ke5=total_ke(v_hist_rk5, masses_5)
    ...
    x = np.arange(t) * dt
    plt.figure(figsize=(10, 6))
    plt.plot(x, ke_rk4, label='year 1 ', c='r')
    plt.plot(x, ke_impl, label='year 2 ', c='hotpink')
    plt.plot(x, ke3, label = 'year3', c = 'purple')
    plt.plot(x, ke3, label = 'year4', c = 'indigo')
    plt.plot(x, ke3, label = 'year5', c = 'b')
    plt.xlabel('Time (s)')
...
def climber_jerk(sets):
    ...
    plt.figure()
    plt.plot(x_jerk[:-10000],jerk_mag[100:-10000],label='implicit')
    plt.plot(x_jerk[:-10000],jerk_mag_rk4[100:-10000], label='RK4')
    plt.title(f'Jerk experienced by the climber, fall factor {fall_factor_rk4}')
    plt.xlabel('time (s)')
    plt.ylabel('ms^-3')
    plt.legend()
    plt.show()
