...
def position(sets):
    ...
    plt.plot(x, y2, label='year 3')
    plt.plot(x2, y3, label='year 2')
...
def plot_force_comparison(sets):
    ...
    data = [f_hist_rk1,f_hist_rk2,f_hist_rk3]
    fall_factor_rk4 = data_r1['fall_factor']
    ...
    plt.plot(x, plotting[1], label='3 yeaer', alpha = 0.8, c = "purple")
    plt.plot(x2, plotting[2], label='2 yeaer', alpha = 0.8, c = "b")
...
def main():
    rope1 = 'rope_simulation_data_rk4year1fall1.npz'
    rope2 = 'rope_simulation_data_rk4year3.npz'
    rope3 = 'rope_simulation_data_rk4year2.npz'
    rope4 = 'implicit_rope_simulation4.npz'
    rope5 = 'implicit_rope_simulation5.npz'

    sets = [rope1,rope2,rope3]
    position(sets)
